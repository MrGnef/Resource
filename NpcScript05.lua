...
function JoJo_01 () -- Pirate Chest
	...
	Talk( 1, "Hi! welcome to Pirate Chest Shop" )
	Text( 1, "Buy Chest and Ring", BuyPage)
	...
	Other(	0613	) -- Lv 70 Crusader Chest of Magenta
	Other(	0614	) -- Lv 70 Sharpshooter Chest of Magenta
	Other(	0615	) -- Lv 70 Voyager Chest of Magenta
	Other(	0616	) -- Lv 70 Cleric Chest of Magenta
	Other(	0322	) -- Lv 70 Seal Master Chest of Magenta
	Other(	0525	) -- Lv 70 Champion Chest of Magenta
...
function dukun_3()
	Talk( 1, "JoJo: Welcome To Class Changer!!." )
	Text( 1, "Lance", JumpPage, 2 )
	Text( 1, "Carsise", JumpPage, 6 )
	Text( 1, "Phillys", JumpPage, 8 )
	Text( 1, "Amy", JumpPage, 17 )

	Talk( 2, "Hi! pay 20k for sec class" )
	Text( 2, "I Want to Be Crusader", JumpPage, 3 )
	Text( 2, "I Want to Be Voyager", JumpPage, 4 )
	Text( 2, "I Want to Be Sharpshooter", JumpPage, 5 )
	...
	-----------carsise------------
	Talk( 6, "Hi! pay 20k for sec class " )
	Text( 6, "I Want to Be Champion", JumpPage, 7 )
	...
	-------------phillys--------------
	Talk( 8, "Hi! pay 20k for sec class" )
	Text( 8, "I want to be Sharpshooter", JumpPage, 9 )
	Text( 8, "I want to be Voyager", JumpPage, 12 )
	Text( 8, "I want to be Seal Master", JumpPage, 13 )
	Text( 8, "I want to be Cleric", JumpPage, 14 )
	...
	TriggerAction( 1, JumpPage, 10 )
	TriggerFailure( 1, JumpPage, 11 )
	Text( 13, "Ok, Herbalis to be Seal Master", MultiTrigger, GetMultiTrigger(), 2)
	...
	TriggerAction( 1, JumpPage, 10 )
	TriggerFailure( 1, JumpPage, 11 )
	Text( 14, "Ok, Herbalis to be Cleric", MultiTrigger, GetMultiTrigger(), 2)
	Text( 14, "No. Maybe later", JumpPage, 8 )

	-------------Amy--------------
	Talk( 17, "Hi! pay 20k for sec class" )
	Text( 17, "I Want to Be Voyager", JumpPage, 20 )
	Text( 17, "I Want to Be Seal Master", JumpPage, 21 )
	Text( 17, "I Want to Be Cleric", JumpPage, 22 )
...
function dukun_2()
	...
	Text( 1, "Carsise", JumpPage, 6 )
	Text( 1, "Phillys", JumpPage, 8 )
	Text( 1, "Amy", JumpPage, 14 )

	Talk( 2, "Hi! pay 5k for first class" )
	Text( 2, "I Want to Be Swordman", JumpPage, 3 )
	Text( 2, "I Want to Be Explorer", JumpPage, 4 )
	Text( 2, "I Want to Be Hunter", JumpPage, 5 )
	...
	-----------carsise------------
	Talk( 6, "Hi! pay 20k for sec class" )
	Text( 6, "I want to be swordman", JumpPage, 7 )
	...
	-------------phillys--------------
	Talk( 8, "Hi! pay 5k for first class" )
	Text( 8, "I Wanna Be Crusader Hunter", JumpPage, 9 )
	Text( 8, "I Wanna Be Crusader Explorer", JumpPage, 12 )
	Text( 8, "I Wanna Be Crusader Herbalis", JumpPage, 13 )
	...
	TriggerAction( 1, JumpPage, 10 )
	TriggerFailure( 1, JumpPage, 11 )
	Text( 13, "Ok, I will become a Herbalis", MultiTrigger, GetMultiTrigger(), 2)
	Text( 13, "No. Maybe later", JumpPage, 8 )


	-------------Amy--------------
	Talk( 14, "Hi! pay 5k for first class" )
	Text( 14, "I Want to Be Explorer", JumpPage, 15 )
	Text( 14, "I Want to Be Herbalis", JumpPage, 16 )
	...
	TriggerAction( 1, JumpPage, 10 )
	TriggerFailure( 1, JumpPage, 11 )
	Text( 16, "Ok, I will become a Herbalis", MultiTrigger, GetMultiTrigger(), 2)
...
function JoJo_10 () -- JoJo Exchanger Note:Note: some equips are not same ID's you have to change to your own ItemInfo
	...
	Text( 1, "Trade for lv85 Unseald Weapon", JumpPage, 31)
	...
	Talk( 31, "обменнник 95 ансов: обменять кели на боты стоит 5 рун кель" )
	Text( 31, "милосердие Эпической Доблести(шарп)", JumpPage, 32)
	Text( 31, "милосердие Чести(круз)", JumpPage, 33)
	Text( 31, "милосердие Жертвы(чамп)", JumpPage, 34)
	Text( 31, "милосердие Правосудия(вой)", JumpPage, 35)
	Text( 31, "милосердие Сочувствия(клер)", JumpPage, 36)
	Text( 31, "милосердие Вдохновения(см)", JumpPage, 37)
	...
	TriggerAction( 1, JumpPage, 27 )
	TriggerFailure( 1, JumpPage, 26 )
	Text(32,"Obtain Item" ,MultiTrigger,GetMultiTrigger(),1)
	...
	TriggerAction( 1, JumpPage, 27 )
	TriggerFailure( 1, JumpPage, 26 )
	Text(33,"Obtain Item" ,MultiTrigger,GetMultiTrigger(),1)
	...
	TriggerAction( 1, JumpPage, 27 )
	TriggerFailure( 1, JumpPage, 26 )
	Text(34,"Obtain Item" ,MultiTrigger,GetMultiTrigger(),1)
	...
	TriggerAction( 1, JumpPage, 27 )
	TriggerFailure( 1, JumpPage, 26 )
	Text(35,"Obtain Item" ,MultiTrigger,GetMultiTrigger(),1)
	...
	TriggerAction( 1, JumpPage, 27 )
	TriggerFailure( 1, JumpPage, 26 )
	Text(36,"Obtain Item" ,MultiTrigger,GetMultiTrigger(),1)
	...
	TriggerAction( 1, JumpPage, 27 )
	TriggerFailure( 1, JumpPage, 26 )
	Text(37,"Obtain Item" ,MultiTrigger,GetMultiTrigger(),1)
