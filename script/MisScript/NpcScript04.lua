...
function mmm_talk30()
	...
	InitFuncList()
	AddFuncList( CreditExchange, 6 )--¶Ô»»Ç®
	...
	InitFuncList()
	AddFuncList( CreditExchange, 7 )--¶Ô»»Ç®
...
function zsts_talk()
	...
	Talk( 1, " Àíãåë ïåðåðîæäåíèÿ: Òîëüêî âåëèêèå îôèöåðû è ïèðàòû ìîãóò ïðîéòè ïåðåðîæäåíèå " )
	Text( 1, " Áîëüøå î ïåðåðîæäåíèè ", JumpPage, 2)
	Text( 1, " ß æåëàþ ïðîéòè ïåðåðîæäåíèå ", JumpPage, 6)
	
	
	Talk( 2, "  Àíãåë ïåðåðîæäåíèÿ: ×òî òåáå íóæíî çíàòü ")
	Text( 2, " Êëàññû ïîñëå ïåðåðîæäåíèÿ ", JumpPage, 3)
	Text( 2, " Ïåðåðàñïðåäåëåíèå ñòàòîâ è ñêèëîâ ïîñëå ïåðåðîæäåíèÿ ", JumpPage, 4)
	Text( 2, " Óñëîâèÿ ïåðåðîæäåíèÿ ", JumpPage, 5)
	
	Talk( 3, " Èãðîêè ìîãóò èçìåíèòü ñâîé êëàññ ïîñëå ïåðåðîæäåíèÿ: Ëàíñ ìîæåò ñòàòü Êðóçîì, Ïóòåøåñòâåííèêîì èëè Îõîòíèêîì. Êàðöèç ìîæåò ñòàòü ×åìïèîíîì. Ôèëëèñ ìîæåò ñòàòü Êëåðèêîì, Êîëäóíüåé, Ïóòåøåñòâåííèöåé, Êðóçîì  èëè Îõîòíèöåé. Àìè ìîæåò ñòàòü Êëåðèêîì, Êîëäóíüåé èëè Ïóòåøåñòâåííèöåé ")
	Text( 3, " Ñïàñèáî.ß âñå ïîíÿë ", CloseTalk)

	Talk( 4, " Âñå î÷êè àòðèáóòîâ  è ñòàòû áóäóò ñáðîøåííû ïîñëå ïåðåðîæäåíèÿ.Òàê æå ñáðîñÿòñÿ è âñå î÷êè óìåíèé. ")
	Text( 4, " Ñïàñèáî.ß âñå ïîíÿë ", CloseTalk)

	Talk( 5, " ×òîáû ïåðåðîäèòüñÿ òåáå íóæíî áóäåò îáðàòèòüñÿ ê Ïîìîùíèêó ïî Ðåáåðíó. Ïîñëå òîãî êàê ïîëó÷èøü ðóíó ïåðâîãî ïåðåðîæäåíèÿ ïîäõîäè êî ìíå .")
	Text( 5, " Ñïàñèáî.ß âñå ïîíÿë ", CloseTalk)

	Talk( 6, " Àíãåë ïåðåðîæäåíèÿ: êåì òû õî÷åøü áûòü ïîñëå ïåðåðîæäåíèÿ " )
	Text( 6, " Õî÷ó áûòü Êðóçîì ", GetChaName1_born, 1)
	Text( 6, " Õî÷ó áûòü ×åìïèîíîì ", GetChaName2_born, 1)
	Text( 6, " Õî÷ó áûòü Ïóòåøåñòâåííèêîì ", GetChaName3_born, 1)
	Text( 6, " Õî÷ó áûòü Îõîòíèêîì ", GetChaName4_born, 1)
	Text( 6, " Õî÷ó áûòü Êëåðèêîì ", GetChaName5_born, 1)
	Text( 6, "Õî÷ó áûòü Êîëäóíüåé ", GetChaName6_born, 1)
	Text( 6, " ß íå õî÷ó ïåðåðîæäàòüñÿ ", CloseTalk)
