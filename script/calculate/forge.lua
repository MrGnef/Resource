...
--	Notice(role , "11111")
	local i = 0
	for i = 0 , 2 , 1 do							--ÅÐ¶ÏµÀ¾ß¶ÔÏó¸öÊýºÍµÀ¾ß¸öÊýÊÇ·ñºÍ·¨
...
--			SystemNotice( role , "ItemCount[i] = "..ItemCount[i])
	...
	if ItemType1 ~= 47 then					--ÅÐ¶Ï¾íÖáÊÇ·ñÕýÈ·
		
		SystemNotice( role ,"This is not a combining scroll")
		return 0
	end

	if ItemType2 ~= 49 or ItemType3 ~= 49 then			--ÅÐ¶ÏÊÇ·ñÊÇ±¦Ê¯
	...
	if ItemID2 ~= ItemID3 then						--ÅÐ¶ÏÁ½¸ö±¦Ê¯ÊÇ·ñÍ¬Àà
...
--	SystemNotice ( arg[1] , "transfer detect can it be combined into main function")
	...
	local BagItem1 = arg [3]						--È¡µÀ¾ß±³°üÎ»ÖÃ
	...
	i = RemoveChaItem ( role , ItemID1 , 1 , 2 , BagItem1 , 2 , 1 , 0)		--ÒÆ³ý¾íÖá
	j = RemoveChaItem ( role , ItemID3 , 1 , 2 , BagItem3 , 2 , 1 , 0)		--ÒÆ³ýÒ»¿Å±¦Ê¯
...
--	Notice ("Must deduct"..Money_Need.."So much gold")
	...
	if b == 0 then
		i = RemoveChaItem ( role , ItemID2 , 1 , 2 , BagItem2 , 2 , 1 , 0)		--ÒÆ³ý±¦Ê¯	
		if i == 0 then
			LG( "Hecheng_BS" , "Delete item failed" )
		end
...
------------------
	...
	R1 = RemoveChaItem ( role , ItemID_Stone1 , 1 , 2 , ItemBag [1] , 2 , 1 , 0 )		--ÒÆ³ý±¦Ê¯1
	R2 = RemoveChaItem ( role , ItemID_Stone2 , 1 , 2 , ItemBag [2] , 2 , 1 , 0 )		--ÒÆ³ý±¦Ê¯2
...
--	local a = 0.75
	...
	if b == 0 then
		i = RemoveChaItem ( role , ItemID_Jinglian , 1 , 2 , ItemBag [0] , 2 , 1 , 0)		--ÒÆ³ý±¦Ê¯	
		if i == 0 then
			LG( "Hecheng_BS" , "Delete item failed" )
		end
		local cha_name = GetChaDefaultName ( role )
...
function Get_StoneLv ( Item )								--¶ÁÈ¡±¦Ê¯µÈ¼¶
	local Lv = GetItemAttr ( Item , ITEMATTR_VAL_BaoshiLV )
	return Lv
end


function Set_StoneLv ( Item , Item_Lv )							--ÉèÖÃ±¦Ê¯µÈ¼¶
	local i = 0
...
--Ëæ»ú±¦Ê¯ÖÖÀà¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª
...
--1¼¶±¦Ê¯¶Ò»»¾í¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª
function Transfer_DiamondScript_Lv1 ( role )			
	local cha = TurnToCha ( role ) 
	local x_give = 0 
	local y_give = 0 
	local script_count = CheckBagItem ( cha , 3877 )					--¼ì²é±³°üÖÐ¶Ò»»È¯ÊýÁ¿
	local DiamondId = Roll_DiamondId ( cha )						--Ëæ»ú¶Ò»»±¦Ê¯µÄÖÖÀà
	if script_count >= 1 then 
		x_del = DelBagItem ( cha , 3877 , 1 ) 
		if x_del == 1 then 
			x_give = GiveItem ( cha , 0 , DiamondId , 1 , 101 )				--¶Ò»»±¦Ê¯

			y_give = GiveItem ( cha , 0 , 885 , 1 , 101 )					--¶Ò»»¾«Á¶Ê¯
...
--2¼¶±¦Ê¯¶Ò»»¾í¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª¡ª
function Transfer_DiamondScript_Lv2 ( role )			
	local cha = TurnToCha ( role ) 
	local x_give = 0 
	local y_give = 0 
	local script_count = CheckBagItem ( cha , 3878 )					--¼ì²é±³°üÖÐ¶Ò»»È¯ÊýÁ¿
	local DiamondId = Roll_DiamondId ( cha )						--Ëæ»ú¶Ò»»±¦Ê¯µÄÖÖÀà
	if script_count >= 1 then 
		x_del = DelBagItem ( cha , 3878 , 1 ) 
		if x_del == 1 then 
			x_give = GiveItem ( cha , 0 , DiamondId , 1 , 102 )				--¶Ò»»±¦Ê¯

			y_give = GiveItem ( cha , 0 , 885 , 1 , 102 )					--¶Ò»»¾«Á¶Ê¯
...
function Transfer_TeamStar( role , level )
	local cha = TurnToCha ( role )  
	local script_count = CheckBagItem ( cha , 1034 )--È¡±³°üÊýÁ¿			
	local chaLV =  GetChaAttr( cha , ATTR_LV)--È¡µÈ¼¶
	local job = GetChaAttr( role, ATTR_JOB) --È¡Ö°Òµ
...
function Transfer_OneStoneScript ( role )
	...
	local script_count = CheckBagItem ( cha , 3885 )					--¼ì²é±³°üÖÐ¶Ò»»È¯ÊýÁ¿
...
function Transfer_OneDiamondScript ( role )
	...
	local x_give = 0 
	local y_give = 0 
	local script_count = CheckBagItem ( cha , 3886 )					--¼ì²é±³°üÖÐ¶Ò»»È¯ÊýÁ¿
	local DiamondId = Roll_DiamondId ( cha )						--Ëæ»ú¶Ò»»±¦Ê¯µÄÖÖÀà
	if script_count >= 1 then 
...
--	SystemNotice( arg[1] , "start transfer parameter analysis")
	...
	local Item_damo = GetChaItem ( role , 2 , ItemBag_damo )					--¶ÁÈ¡´òÄ¥µÀ¾ßµÄÖ¸Õë
	local Item_Cailiao1 = GetChaItem ( role , 2 , ItemBag [1] )					--¶ÁÈ¡´òÄ¥²ÄÁÏ1µÄÖ¸Õë
	local Item_Cailiao2 = GetChaItem ( role , 2 , ItemBag [2] )					--¶ÁÈ¡´òÄ¥²ÄÁÏ2µÄÖ¸Õë
...
--	Notice ("Must deduct"..Money_Need.."So much gold")
	...
	R1 = RemoveChaItem ( role , ItemID_Cailiao1 , 1 , 2 , ItemBag [1] , 2 , 1 , 0 )		--ÒÆ³ý²ÄÁÏ1
	R2 = RemoveChaItem ( role , ItemID_Cailiao2 , 1 , 2 , ItemBag [2] , 2 , 1 , 0 )		--ÒÆ³ý²ÄÁÏ2
...
--------È¡³öµÀ¾ßÖ¸Õë
	local Item_Juanzhou = GetChaItem ( role , 2 , ItemBag [0] )	--¾íÖáÖ¸Õë
	local Item_Waiguan = GetChaItem ( role , 2 , ItemBag [1] )	--Íâ¹ÛµÀ¾ßÖ¸Õë
...
--------Íâ¹ÛºÍÊôÐÔµÀ¾ßÊÇ·ñÎªÍ¬Ò»ÀàÐÍ
	local ItemType_Shuxing = GetItemType ( Item_Shuxing )
	local ItemType_Waiguan = GetItemType ( Item_Waiguan )
	local star=0
	if ItemType_Shuxing ~= 22 and ItemType_Shuxing ~=27 then ----¼È²»ÊÇÎÆÉíÒ²²»ÊÇÒÂ·þ
	star = 1
	end
...
--------Íâ¹ÛºÍÊôÐÔµÀ¾ßÊÇ·ñÎªÍ¬Ò»ÌåÐÍºÍÖ°ÒµÏÞÖÆ
...
function getfusion_money_main ( Table )
	...
	local role = 0
	local ItemBag = {}										--µÀ¾ß±³°üÎ»ÖÃÊý×é
	local ItemCount = {}										--µÀ¾ßÊýÁ¿Êý×é
	local ItemBagCount = {}									--µÀ¾ß¶ÔÏóÊýÁ¿Êý×é
	local ItemBag_Num = 0									--±³°üÎ»ÖÃÊý×é³¤¶È
	local ItemCount_Num = 0									--µÀ¾ßÊýÁ¿Êý×é³¤¶È
	local ItemBagCount_Num = 0								--µÀ¾ß¶ÔÏóÊýÁ¿Êý×é³¤¶È
...
--------¸³ÓèÈÛºÏµÀ¾ßµÈ¼¶
	...
	if flg==1 then
		if ItemID_star < 5000 then 
			...
			star_lv=GetItemAttr ( Item_Shuxing , ITEMATTR_VAL_LEVEL )                                     -- ÉèÖÃÈÛºÏµÀ¾ßµÈ¼¶
		end
	else 
		star_lv=10
	end
	--SystemNotice( role , "star_lv="..star_lv )
	SetItemAttr ( Item_Waiguan , ITEMATTR_VAL_LEVEL , star_lv )                                     -- ÉèÖÃÈÛºÏµÀ¾ßµÈ¼¶
	...
	local R2 = 0
	local R3 = 1
	R1 = RemoveChaItem ( role , ItemID_Juanzhou , 1 , 2 , ItemBag [0] , 2 , 1 , 0 )		--ÒÆ³ý¾íÖáµÀ¾ß
	R2 = RemoveChaItem ( role , ItemID_Shuxing , 1 , 2 , ItemBag [2] , 2 , 1 , 0 )		--ÒÆ³ýÊôÐÔµÀ¾ß
	if ItemID_Cuihuaji ~= 0 then
		R3 = RemoveChaItem ( role , ItemID_Cuihuaji , 1 , 2 , ItemBag [3] , 2 , 1 , 0 )	--ÒÆ³ö´ß»¯¼ÁµÀ¾ß
	end
	...
	if ItemID_Cuihuaji ~= 0 then
		...
		local Part1_Jinglianxinxi = GetNum_Part1 ( Jinglianxinxi )	--Get Num Part 1 µ½ Part 7
		...
		Jinglianxinxi = SetNum_Part1 ( Jinglianxinxi , hole_num ) ----------¶þ×ª±ê¼Ç
...
function can_beuplv_item_main ( Table )
	...
	local Item_beuplv = GetChaItem ( role , 2 , ItemBag_beuplv ) ----È¡µÀ¾ßÖ¸Õë

	local Item_beuplv_Type = GetItemType ( Item_beuplv )		----È¡ÈÚºÏµÀ¾ßÀàÐÍ
	local Item_beuplv_ID = GetItemID ( Item_beuplv )		----È¡ÈÚºÏµÀ¾ßID
	local Item_ScItem = GetChaItem ( role , 2 , ItemBag [0] )	----Ç¿»¯¾íÖáµÀ¾ßÖ¸Õë
	local Item_YxItem = GetChaItem ( role , 2 , ItemBag [2] )	----Ç¿»¯¾§Ê¯µÀ¾ßÖ¸Õë
	local Item_ScItem_ID = GetItemID ( Item_ScItem )		----ÉÌ³ÇµÀ¾ßID
	local Item_YxItem_ID = GetItemID ( Item_YxItem )		----ÓÎÏ·µÀ¾ßID
	local Item_ScItem_Type = GetItemType ( Item_ScItem )		----È¡Ç¿»¯¾íÖáµÀ¾ßÀàÐÍ
	local Item_YxItem_Type = GetItemType ( Item_YxItem )		----È¡Ç¿»¯¾§Ê¯µÀ¾ßÀàÐÍ


	local Item_beuplv_Lv =  Get_Itembeuplv_Lv ( Item_beuplv )	---È¡ÈÚºÏ×¡×°±¸µÈ¼¶
	
	local ItemAttr_Val_Fusionid = GetItemAttr ( Item_beuplv , ITEMATTR_VAL_FUSIONID ) -- È¡µÀ¾ß×°±¸ÈÛºÏÐÅÏ¢ID

	if Item_beuplv_ID < 5001 or Item_beuplv_ID > 6000 then					--ÅÐ¶ÏÈÚºÏµÀ¾ßÊÇ·ñÎªÈÚºÏÀàÐÍ
...
-----------------------------------------------
	if Item_beuplv_Lv >= 15 then					--ÅÐ¶ÏÈÚºÏµÀ¾ßÊÇ·ñÎª×î´óµÈ¼¶		
		SystemNotice( role ,"Item level limit max. Unable to level again")
		return 0
	end
	if ItemBagCount_beuplv ~= 1 then				--µÚ¶þÀ¸·ÅÈÚºÏµÀ¾ß
	...
	if ItemCount [0] ~= 1 or ItemCount [2] ~= 1 or ItemBagCount [0] ~= 1 or ItemBagCount [2] ~= 1 then  ----µÚÒ»À¸ºÍµÚÈýÀ¸·ÅÉÌ³ÇµÀ¾ßºÍÓÎÏ·µÀ¾ß
...
function begin_upgrade_item (...)
	...
	local ItemBag_beuplv = ItemBag [1]
	local Item_beuplv = GetChaItem ( role , 2 , ItemBag_beuplv )    ----ÈÚºÏ×°±¸µÀ¾ßÖ¸Õë
	local Item_ScItem = GetChaItem ( role , 2 , ItemBag [0] )	----Ç¿»¯¾íÖáµÀ¾ßÖ¸Õë
	local Item_YxItem = GetChaItem ( role , 2 , ItemBag [2] )	----Ç¿»¯¾§Ê¯µÀ¾ßÖ¸Õë
	local Item_ScItem_ID = GetItemID ( Item_ScItem )		----ÉÌ³ÇµÀ¾ßID
	local Item_YxItem_ID = GetItemID ( Item_YxItem )		----ÓÎÏ·µÀ¾ßID
	...
	R1 = RemoveChaItem ( role , Item_ScItem_ID , 1 , 2 , ItemBag [0] , 2 , 1 , 0 )		--ÒÆ³ýÉÌ³ÇµÀ¾ß
	R2 = RemoveChaItem ( role , Item_YxItem_ID , 1 , 2 , ItemBag [2] , 2 , 1 , 0 )		--ÒÆ³ýÓÎÏ·µÀ¾ß
	...
	Money_Have = Money_Have - Money_Need
	SetCharaAttr ( Money_Have , role , ATTR_GD )
	ALLExAttrSet( role )						--¸ù¾Ý½ÇÉ«ÐÎÌ¬·Ö±ðË¢ÐÂµ±Ç°ÊôÐÔ

	local a = Check_CG_beuplv ( Item_beuplv_Lv )			---²»Í¬µÈ¼¶µÄ³É¹¦¸ÅÂÊ
	...
	Set_Itembeuplv_Lv ( Item_beuplv , Item_beuplv_Lv )		-------ÉèÈÚºÏ×¡×°±¸µÈ¼¶
	...
	--check_item_final_data ( Item_beuplv )				-----ÊôÐÔÖØËã
	SynChaKitbag(role,13)
...
-------------------------------
--function beuplv ( item )						----------ÈÚºÏ×°±¸Éý¼¶Ð§¹û
...
-------------------------------
function Get_Itembeuplv_Lv ( Item )								--¶ÁÈ¡ÈÚºÏ×°±¸µÈ¼¶
...
---------------------------------
function Set_Itembeuplv_Lv ( Item , Item_Lv )							--ÉèÖÃ×°±¸µÈ¼¶
	local i = 0
...
----------------------------
function Check_CG_beuplv ( Item_Lv )				-------²»Í¬µÈ¼¶µÄ³É¹¦¸ÅÂÊ
	local	ran = math.random ( 1, 100 )

	if Item_Lv <= 10 then					-------10¼¶ÒÔÏÂ100%³É¹¦
		return 1
	end
	if Item_Lv>10 and Item_Lv <= 15 then			-------10µ½15¼¶ÒÔÏÂ50%³É¹¦
		if ran <= 50 then
		return 1
		else
		return 0
	...
	if Item_Lv>15 and Item_Lv <= 20 then			-------15µ½20¼¶ÒÔÏÂ10%³É¹¦
		if ran <= 10 then
		return 1
		else
		return 0
...
function can_jlborn_item_main ( Table )
	...
	----È¡³öµÀ¾ßÖ¸Õë
	local Item_EMstone = GetChaItem ( role , 2 , ItemBag [0] )	--¶ñÄ§±¦Ê¯Ö¸Õë
	local Item_JLone = GetChaItem ( role , 2 , ItemBag [1] )	--Ò»¸ö¾«ÁéµÀ¾ßµÄÖ¸Õë
	local Item_JLother = GetChaItem ( role , 2 , ItemBag [2] )	--ÁíÒ»¸ö¾«ÁéµÀ¾ßµÄÖ¸Õë
	local Item_JLone_ID = GetItemID ( Item_JLone )   --Ò»¸ö¾«ÁéµÀ¾ßID
	local Item_JLother_ID = GetItemID ( Item_JLother )   --Ò»¸ö¾«ÁéµÀ¾ßID
	---È¡Ò»¸ö¾«ÁéµÄÎå¸öÊôÐÔ
	local str_JLone = GetItemAttr( Item_JLone ,ITEMATTR_VAL_STR )		 --Á¦Á¿
	local con_JLone = GetItemAttr( Item_JLone ,ITEMATTR_VAL_CON )		--ÌåÖÊ
	local agi_JLone = GetItemAttr( Item_JLone ,ITEMATTR_VAL_AGI )		--×¨×¢
	local dex_JLone = GetItemAttr( Item_JLone ,ITEMATTR_VAL_DEX )		--Ãô½Ý
	local sta_JLone = GetItemAttr( Item_JLone ,ITEMATTR_VAL_STA )		--¾«Éñ
	local URE_JLone = GetItemAttr( Item_JLone ,ITEMATTR_URE )		--ÌåÁ¦
	local MAXURE_JLone = GetItemAttr( Item_JLone ,ITEMATTR_MAXURE )       --×î´óÌåÁ¦
	local lv_JLone = str_JLone + con_JLone + agi_JLone + dex_JLone + sta_JLone  ----Ò»¸ö¾«ÁéµÄµÈ¼¶
	---È¡ÁíÒ»¸ö¾«ÁéµÄÎå¸öÊôÐÔ
	local str_JLother = GetItemAttr( Item_JLother ,ITEMATTR_VAL_STR )       --Á¦Á¿
	local con_JLother = GetItemAttr( Item_JLother ,ITEMATTR_VAL_CON )       --ÌåÖÊ
	local agi_JLother = GetItemAttr( Item_JLother ,ITEMATTR_VAL_AGI )       --×¨×¢
	local dex_JLother = GetItemAttr( Item_JLother ,ITEMATTR_VAL_DEX )       --Ãô½Ý
	local sta_JLother = GetItemAttr( Item_JLother ,ITEMATTR_VAL_STA )       --¾«Éñ
	local URE_JLother = GetItemAttr( Item_JLother ,ITEMATTR_URE )		 --ÌåÁ¦
	local MAXURE_JLother = GetItemAttr( Item_JLother ,ITEMATTR_MAXURE )       --×î´óÌåÁ¦
	local lv_JLother = str_JLother + con_JLother + agi_JLother + dex_JLother + sta_JLother ----ÁíÒ»¸ö¾«ÁéµÄµÈ¼¶
	----È¡Ò»¸ö¾«ÁéµÄ7Î»ÊýÖµ
	...
	local Part1_JLother = GetNum_Part1 ( Num_JLother )	--Get Num Part 1 µ½ Part 7
	...
	local i1 = CheckBagItem( role, 4530 )			---ÃÀÎ¶ÎÚÔôÈâ
	local i2 = CheckBagItem( role,3434 )			----·ÏÁéÎäÊ¿º¡¹Ç
	...
	local i1 = CheckBagItem( role, 4531 )			---ÆÆËéµÄ°¢À­²®ÕäÖé 
	local i2 = CheckBagItem( role, 3435 )			----·ÏÁé¹­¼ýÊÖº¡¹Ç   
		if i1 < 10 or i2 < 10 then
			SystemNotice( role ,"Fairy marriage lack some required items")
			return 0
		end
	...
	local i1 = CheckBagItem( role,1196 )			---°¢À­²®ÕäÖéËéÆ¬
	local i2 = CheckBagItem( role,3436 )			----ÆüÁéÎäÊ¿º¡¹Ç  
		if i1 < 10 or i2 < 10 then
			SystemNotice( role ,"Fairy marriage lack some required items")
			return 0
		end
	...
	local i1 = CheckBagItem( role, 4533 )			---òòò½Î²°Í           
	local i2 = CheckBagItem( role, 3437 )			----ÆüÁé¹­¼ýÊÖº¡¹Ç 
		if i1 < 10 or i2 < 10 then
			SystemNotice( role ,"Fairy marriage lack some required items")
			return 0
		end
	...
	local i1 = CheckBagItem( role,4537 )			---Óã´Ì                      
	local i2 = CheckBagItem( role,3444 )			----Äà½¬¿é   
		if i1 < 10 or i2 < 10 then
			SystemNotice( role ,"Fairy marriage lack some required items")
			return 0
		end
	...
	local i1 = CheckBagItem( role, 4540 )			---öèÓã±³÷¢             
	local i2 = CheckBagItem( role, 3443 )			----ÕÓÔó¿ÝÄ¾   
		if i1 < 10 or i2 < 10 then
			SystemNotice( role ,"Fairy marriage lack some required items")
			return 0
		end
	...
	local i1 = CheckBagItem( role, 1253 )			---ÉÁ¹âµÄ°¢À­²®ÕäÖéËéÆ¬
	local i2 = CheckBagItem( role, 3442 )			----ÎÛÄà¿é                    
		if i1 < 10 or i2 < 10 then
			SystemNotice( role ,"Fairy marriage lack some required items")
			return 0
		end
...
function jlborn_item ( Table )
	...
	local Item_JLone = GetChaItem ( role , 2 , ItemBag [1] )					--Ò»¸ö¾«ÁéµÀ¾ßµÄÖ¸Õë
	local Item_JLother = GetChaItem ( role , 2 , ItemBag [2] )				--ÁíÒ»¸ö¾«ÁéµÀ¾ßµÄÖ¸Õë
	local  Item_EMstone_ID = GetItemID ( Item_EMstone )					 --¶ñÄ§¹ûÊµID
	local  Item_JLone_ID = GetItemID ( Item_JLone )						 --Ò»¸ö¾«ÁéµÀ¾ßID
	local  Item_JLother_ID = GetItemID ( Item_JLother )					 --Ò»¸ö¾«ÁéµÀ¾ßID
	---È¡Ò»¸ö¾«ÁéµÄÎå¸öÊôÐÔ
	local str_JLone = GetItemAttr( Item_JLone ,ITEMATTR_VAL_STR )			  --Á¦Á¿ 
	local con_JLone = GetItemAttr( Item_JLone ,ITEMATTR_VAL_CON )			 ---ÌåÖÊ 
	local agi_JLone = GetItemAttr( Item_JLone ,ITEMATTR_VAL_AGI )			 --Ãô½Ý 
	...
	local str_JLother = GetItemAttr( Item_JLother ,ITEMATTR_VAL_STR )		--Á¦Á¿
	local con_JLother = GetItemAttr( Item_JLother ,ITEMATTR_VAL_CON )		  --ÌåÖÊ
	local agi_JLother = GetItemAttr( Item_JLother ,ITEMATTR_VAL_AGI )		 --Ãô½Ý
	...
	if new_MAXURE > 32000 then
		...
		--------¶ñÄ§¹ûÊµÅÐ¶Ï
	if Item_EMstone_ID ==3918 then ---ÇàÉ¬¶ñÄ§¹ûÊµ
		local j1 =TakeItem( role, 0, 4530, 10 )			---ÃÀÎ¶ÎÚÔôÈâ     
		...
		if Item_JLone_ID ==680 or Item_JLother_ID ==680 then
			...
			elseif lv_JLone>=20 and lv_JLone<25 and lv_JLother >=20 and lv_JLother<25 and rad>=88 then---12%ÎªÄ¦¶¹¶þÊÀ
				r1,r2 =MakeItem ( role , 681  , 1 , 4 )
			elseif lv_JLone>=25 and lv_JLone<35 and lv_JLother >=25 and lv_JLother<35 and rad>=50 then ---50%ÎªÄ¦¶¹¶þÊÀ
				r1,r2 =MakeItem ( role , 681  , 1 , 4 )
		...
		local Item_newJL = GetChaItem ( role , 2 , r2 )			--È¡ÐÂ¾«ÁéµÀ¾ßÖ¸Õë
		...
		Num_newJL = SetNum_Part1 ( Num_newJL , 1 )	 ----------¶þ×ª±ê¼Ç
	...
	if Item_EMstone_ID ==3919 then ---ÓÂÕß¶ñÄ§¹ûÊµ  ÌåÖ®¾«Áé----ÌåÖÊ¼Ó·ÀÓù
		local j1 = TakeItem( role, 0, 4531, 10 )			---ÆÆËéµÄ°¢À­²®ÕäÖé  
		local j2 = TakeItem( role, 0,3435, 10 )			----·ÏÁé¹­¼ýÊÖº¡¹Ç    
		if j1==0 or j2==0 then
			SystemNotice ( role ,"Deletion of pet fairy reborn tools failed")
			return
		end
	...
	if Item_EMstone_ID ==3920 then ---Á¦Á¿¶ñÄ§¹ûÊµ Á¦Ö®¾«Áé----Á¦Á¿¼Ó¹¥»÷
		local j1 =TakeItem( role, 0, 1196, 10 )			---°¢À­²®ÕäÖéËéÆ¬  
		local j2 = TakeItem( role, 0,3436, 10 )			----ÆüÁéÎäÊ¿º¡¹Ç    
		if j1==0 or j2==0 then
			SystemNotice ( role ,"Deletion of pet fairy reborn tools failed")
			return
		end
	...
	if Item_EMstone_ID ==3921 then ---ÖÇ»Û¶ñÄ§¹ûÊµ ÉñÖ®¾«Áé ¾«Éñ¼Ó·ÀÓù
		local j1 =TakeItem( role, 0, 4533, 10 )			---òòò½Î²°Í            
		local j2 = TakeItem( role, 0,3437, 10 )			----ÆüÁé¹­¼ýÊÖº¡¹Ç  
		if j1==0 or j2==0 then
			SystemNotice ( role ,"Deletion of pet fairy reborn tools failed")
			return
		end
	...
	if Item_EMstone_ID ==3922 then ---ÄÜÁ¿¶ñÄ§¹ûÊµ ×¨Ö®¾«Áé ×¨×¢¼Ó¹¥»÷
		local j1 =TakeItem( role, 0,4537, 10 )			---Óã´Ì                     
		local j2 = TakeItem( role, 0,3444, 10 )			----Äà½¬¿ì  
		if j1==0 or j2==0 then
			SystemNotice ( role ,"Deletion of pet fairy reborn tools failed")
			return
		end
		...
		local Item_newJL = GetChaItem ( role , 2 , r2 )			--È¡ÐÂ¾«ÁéµÀ¾ßÖ¸Õë
		local Num_newJL = GetItemForgeParam ( Item_newJL , 1 )
		local Part1_newJL = GetNum_Part1 ( Num_JLother )	--Get Num Part 1 µ½ Part 7
		local Part2_newJL = GetNum_Part2 ( Num_newJL )	
		local Part3_newJL = GetNum_Part3 ( Num_newJL )
		local Part4_newJL = GetNum_Part4 ( Num_newJL )
		local Part5_newJL = GetNum_Part5 ( Num_newJL )
	...
	if Item_EMstone_ID ==3924 then ---ÆæÒì¶ñÄ§¹ûÊµ ÃôÖ®¾«Áé Ãô½Ý¼Ó·ÀÓù
		local j1 = TakeItem( role, 0,4540, 10 )			---öèÓã±³÷¢              
		local j2 = TakeItem( role, 0,3443, 10 )			----ÕÓÔó¿ÝÄ¾    
		if j1==0 or j2==0 then
			SystemNotice ( role ,"Deletion of pet fairy reborn tools failed")
			return
		end
	...
	if Item_EMstone_ID ==3925 then ---ÉñÃØ¶ñÄ§¹ûÊµ Ð°Ö®¾«Áé ¾­Ñé¼Ó³É
		local j1 = TakeItem( role, 0,1253, 10 )			---ÉÁ¹âµÄ°¢À­²®ÕäÖéËéÆ¬        
		local j2 = TakeItem( role, 0,3442, 10 )			----ÎÛÄà¿é    
		if j1==0 or j2==0 then
			SystemNotice ( role ,"Deletion of pet fairy reborn tools failed")
			return
		end
	...
	R1 = RemoveChaItem ( role , Item_EMstone_ID , 1 , 2 , ItemBag [0] , 2 , 1 , 0 )		--ÒÆ³ý¶ñÄ§¹ûÊµ
	if R1 == 0  then
...
function can_tichun_item_main ( Table )
	...
	--------È¡³öµÀ¾ßÖ¸Õë
	local Item_mainitem = GetChaItem ( role , 2 , ItemBag [0] )	--Ö÷×°±¸µÀ¾ßÖ¸Õë
	local Item_otheritem = GetChaItem ( role , 2 , ItemBag [1] )	--¸¨Öú×°±¸µÀ¾ßÖ¸Õë
	--------È¡µÀ¾ßÀàÐÍ	
	...
	-------Èç¹ûÊÇÈÛºÏ¹ýµÄ×°±¸ÔòÈ¡ÆäÔ­Ê¼ID
	if ItemID_main > 5000 then
		ItemID_main = GetItemAttr( Item_mainitem , ITEMATTR_VAL_FUSIONID )
	end
	-------ÊÇ·ñÊôÓÚÊôÐÔ¿ÉÌáÉý×°±¸
	local flg=0
	if ItemID_main==825 or ItemID_main==826 or ItemID_main==827  or ItemID_main==828 then---------ÄêÊÞÌáÉý
		if ItemID_other==2403 then
			flg=1
		end
	end
	if ItemID_main==845 or ItemID_main==846 or ItemID_main==847  or ItemID_main==848 then---------ºÚÁúÌáÉý
		if ItemID_other==2404 then
			flg=1
		end
	end
	if ItemID_main>=2530 and ItemID_main<=2532 then---------70¼¶¾Þ½£BOSS×°Éý¼¶ÏßÍÅ
		if ItemID_other==2562 then
			flg=1
		end
	end
	if ItemID_main>=2533 and ItemID_main<=2535 then---------70¼¶Ë«½£BOSS×°Éý¼¶ÏßÍÅ
		if ItemID_other==2563 then
			flg=1
		end
	end
	if ItemID_main>=2536 and ItemID_main<=2538 then---------70¼¶¾Ñ»÷BOSS×°Éý¼¶ÏßÍÅ
		if ItemID_other==2564 then
			flg=1
		end
	end
	if ItemID_main>=2539 and ItemID_main<=2541 then---------70¼¶º½º£BOSS×°Éý¼¶ÏßÍÅ
		if ItemID_other==2565 then
			flg=1
		end
	end
	if ItemID_main>=2542 and ItemID_main<=2544 then---------70¼¶Ê¥Ö°BOSS×°Éý¼¶ÏßÍÅ
		if ItemID_other==2566 then
			flg=1
		end
	end
	if ItemID_main>=2545 and ItemID_main<=2547 then---------70¼¶·âÓ¡BOSS×°Éý¼¶ÏßÍÅ
...
function tichun_item ( Table )
	...
	-------ÄêÊÞÌáÉý
	if ItemID_main==825  then---------ÄêÊÞÉíÌáÉý
		r1,r2 =MakeItem ( role , 2549  , 1 , 4 )
	end
	if ItemID_main==826  then---------ÄêÊÞÊÖÌáÉý
		r1,r2 =MakeItem ( role , 2550  , 1 , 4 )
	end
	if ItemID_main==827  then---------ÄêÊÞ½ÅÌáÉý
		r1,r2 =MakeItem ( role , 2551  , 1 , 4 )
	end
	if ItemID_main==828  then---------ÄêÊÞÍ·ÌáÉý
	...
	---------70BOSSÌáÉý
	if ItemID_main>=2530 and ItemID_main<=2547 then---------70BOSSÌáÉý
		ItemID_main=ItemID_main+287
		r1,r2 =MakeItem ( role , ItemID_main  , 1 , 4)
	end
	local R1 = 0
	local R2 = 0
	R1 = RemoveChaItem ( role , ItemID_mainitem , 1 , 2 , ItemBag [0] , 2 , 1 , 1 )	--ÒÆ³ýµÀ¾ß
	R2 = RemoveChaItem ( role , ItemID_otheritem , 1 , 2 , ItemBag [1] , 2 , 1 , 1 )	--ÒÆ³ýµÀ¾ß
	if R1==0 or R2==0 then
		SystemNotice( role , "moved item failed ")
		return
	end
...
--±´¿Ç³äµç
--ÅÐ¶ÏÊÇ·ñÄÜ¹»±´¿Ç³äµç£¬±´¿Ç³äµçº¯ÊýÈë¿Ú
...
function can_energy_item_main ( Table )
	...
	--------È¡³öµÀ¾ßÖ¸Õë
	local Item_mainitem = GetChaItem ( role , 2 , ItemBag [0] )	--±´¿ÇµÀ¾ßÖ¸Õë
	local Item_otheritem = GetChaItem ( role , 2 , ItemBag [1] )	--µç³ØµÀ¾ßÖ¸Õë
	--------È¡µÀ¾ßÀàÐÍ	
	local  ItemType_mainitem = GetItemType ( Item_mainitem )
	local  ItemType_otheritem = GetItemType ( Item_otheritem )
	...
	local Item_mainitem_Lv =  GetItemLv ( Item_mainitem )
	-------È¡±´¿ÇÄÜÁ¿
	local item_energy = GetItemAttr(Item_mainitem,ITEMATTR_ENERGY) ---µ±Ç°ÄÜÁ¿
	local item_maxenergy = GetItemAttr(Item_mainitem,ITEMATTR_MAXENERGY) ---×î´óÄÜÁ¿
...
function energy_item ( Table )
	...
	local R1 = 0
	R1 = RemoveChaItem ( role , Item_otheritem , 1 , 2 , ItemBag [1] , 2 , 1 , 0 )		--ÒÆ³ýµç³Ø
	if R1 == 0 then
		SystemNotice( role , "moved item failed ")
		return
	end
...
--ÌáÈ¡±¦Ê¯
--ÅÐ¶ÏÊÇ·ñÄÜ¹»ÌáÈ¡±¦Ê¯£¬ÌáÈ¡±¦Ê¯º¯ÊýÈë¿Ú
...
function can_getstone_item_main( Table )
	...
	--------È¡³öµÀ¾ßÖ¸Õë
	local Item_mainitem = GetChaItem ( role , 2 , ItemBag [0] )	--×°±¸µÀ¾ßÖ¸Õë
	local Item_otheritem = GetChaItem ( role , 2 , ItemBag [1] )	--Ìú½³µÄÇ¯×ÓµÀ¾ßÖ¸Õë
	--------È¡µÀ¾ßÀàÐÍ	
	local  ItemType_mainitem = GetItemType ( Item_mainitem )
	local  ItemType_otheritem = GetItemType ( Item_otheritem )
	--------È¡µÀ¾ßID
...
function getstone_item ( Table )
	...
	local r2 = 0
	local Item_Lv = 0
	local item_tureID=0	---------È¡³öµÄ±¦Ê¯µÀ¾ßID
	...
	local Item_ture = GetChaItem ( role , 2 , r2 ) ---------È¡³öµÄ±¦Ê¯Ö¸Õë
	---------ÉèÖÃ±¦Ê¯µÈ¼¶ 
	...
	local R1 = 0
	R1 = RemoveChaItem ( role , ItemID_otheritem , 1 , 2 , ItemBag [1] , 2 , 1 , 0 )		--ÒÆ³ýÇ¯×Ó
	if R1 == 0 then
		SystemNotice( role , "moved item failed ")
		return
	end
...
---------------------------------------------------------------------------------------------Ð°¶ñµÄ·Ö¸îÏß£¨ÏÂÃæÊÇµÀ¾ßÖÆ×÷½Å±¾£¬Ð»Ð»£©---------------------------------------------------
...
function can_manufacture_item_main ( Table )
	...
	local role = 0
	local ItemBag = {}										--µÀ¾ß±³°üÎ»ÖÃ
	local ItemBagCount = 0										--µÀ¾ß¶ÔÏóÊýÁ¿
	...
	local ItemID = {}
	local ItemType = {}
	for i = 1 , ItemBagCount , 1 do							--ÅÐ¶ÏµÀ¾ß¸öÊýÊÇ·ñºÍ·¨
		--if ItemBag[i] == 0  then
		--	SystemNotice( role , "Illegal item unit")
		--	return 0
		--end
		--È¡³öµÀ¾ß(1-¾«Áé,2-Í¼Ö½,3-¹¤¾ß,4,5,6-²ÄÁÏA,B,C)
		Item[i] = GetChaItem ( role , 2 , ItemBag [i] )			--È¡µÀ¾ßÖ¸Õë
		ItemID[i] = GetItemID ( Item[i] )						--È¡µÀ¾ßID
		ItemType[i] = GetItemType ( Item[i] )					 --È¡µÀ¾ßÀàÐÍ
	end
	...
	local URE_JLone = GetItemAttr( Item[1] ,ITEMATTR_URE )		--ÌåÁ¦
	if URE_JLone<=0 then
		SystemNotice( role ,"Almighty: This is too cruel! Please feed your pet fairy!")
		return 0	
	end
	--------ÅÐ¶Ï¾«ÁéÊÇ·ñ¾ßÓÐ´ËÖÖÉú»î¼¼ÄÜ
	local Num_JL = GetItemForgeParam ( Item[1] , 1 )
	Num_JL = TansferNum ( Num_JL )
	local Part1_JL = GetNum_Part1 ( Num_JL )	--Get Num Part 1 µ½ Part 7
	...
	if ItemID[2]==2300 then ---------ÖÆÔìÍ¼Ö½
		...
		life_lv=GetSkillLv( role , SK_ZHIZAO )	-----È¡½ÇÉ«ÖÆÔì¼¼ÄÜµÈ¼¶
	end
	if ItemID[2]==2301 then ---------ÖýÔìÍ¼Ö½
		if Part2_JL==14 then
			JL_jineng=Part2_JL
			JL_jineng_lv=Part3_JL
		...
		life_lv=GetSkillLv( role , SK_ZHUZAO )	-----È¡½ÇÉ«ÖýÔì¼¼ÄÜµÈ¼¶
	end
	if ItemID[2]==2302 then ---------Åëâ¿Í¼Ö½
		if Part2_JL==16 then
			JL_jineng=Part2_JL
			JL_jineng_lv=Part3_JL
		...
		life_lv=GetSkillLv( role , SK_PENGREN )	-----È¡½ÇÉ«Åëâ¿¼¼ÄÜµÈ¼¶
	end
	if ItemID[3]~=1067 and ItemID[3]~=1068 and ItemID[3]~=1069 then---------¹¤¾ß´æÔÚ
		SystemNotice( role ,"Please use tool")
		return 0	
	end
	if ItemID[3]==1067 or ItemID[3]==1068 or ItemID[3]==1069 or ItemID[3]==1070 then---------¹¤¾ß´æÔÚ
		...
		if ItemID[3]==1068 and  ItemID[2]~=2300 then-------ÖÆÔìÀà¹¤¾ß
			SystemNotice( role ,"Tool and Blueprint mismatch")
			return 0			
		end
		if ItemID[3]==1069 and  ItemID[2]~=2301 then-------ÖýÔìÀà¹¤¾ß
			SystemNotice( role ,"Tool and Blueprint mismatch")	
			return 0			
		end	
		if ItemID[3]==1067 and ItemID[2]~=2302 then-------Åëâ¿Àà¹¤¾ß
			SystemNotice( role ,"Tool and Blueprint mismatch")
			return 0			
		end
	...
	--È¡Í¼Ö½²ÄÁÏÊý¾Ý£¬°üÀ¨µÀ¾ßID£¬²ÄÁÏ1£¬²ÄÁÏ2£¬²ÄÁÏ3£¬Á÷³ÌÊý£¬»ù±¾³É¹¦ÂÊ£¬¾«ÁéÓ²±ÒÏûºÄ£¬Í¼Ö½µÈ¼¶
	local paper_lv = GetItemAttr(Item[2], ITEMATTR_URE )--È¡Í¼Ö½µÈ¼¶	
	if life_lv<paper_lv then
		SystemNotice( role ,"Character skill level does not match Blueprint level")
		return 0
	end
	local paper_id1=GetItemAttr(Item[2], ITEMATTR_VAL_STR )--ÐèÇóµÀ¾ß1ID
	--SystemNotice( role ,"Required item 1ID=="..paper_id1)

	local paper_id2=GetItemAttr(Item[2], ITEMATTR_VAL_CON )--ÐèÇóµÀ¾ß2ID
	--SystemNotice( role ,"Required item 2ID=="..paper_id2)

	local paper_id3=GetItemAttr(Item[2], ITEMATTR_VAL_DEX )--ÐèÇóµÀ¾ß3ID	
	...
	--------------¼ì²âÎïÆ·ÐèÇóµÄÊýÁ¿ÊÇ·ñÂú×ã
	local Num_paper = GetItemForgeParam ( Item[2] , 1 )---------È¡Í¼Ö½ÖÐËùÐè¸÷ÖÖÎïÆ·µÄÊýÁ¿
	Num_paper = TansferNum ( Num_paper )
	local Part1_paper = GetNum_Part1 ( Num_paper )	--Get Num Part 1 µ½ Part 7
	local Part2_paper = GetNum_Part2 ( Num_paper )	--ÐèÇóµÀ¾ß1ÊýÁ¿
	--SystemNotice( role ,"Required Item 1 Quantity=="..Part2_paper)

	local Part3_paper = GetNum_Part3 ( Num_paper )	
	local Part4_paper = GetNum_Part4 ( Num_paper )	--ÐèÇóµÀ¾ß2ÊýÁ¿
	--SystemNotice( role ,"Required item 2 quantity=="..Part4_paper)

	local Part5_paper = GetNum_Part5 ( Num_paper )
	local Part6_paper = GetNum_Part6 ( Num_paper )	--ÐèÇóµÀ¾ß3ÊýÁ¿
	...
	local paper_num=GetItemAttr(Item[2], ITEMATTR_VAL_STA )--Í¼Ö½Ê¹ÓÃ´ÎÊý
		--SystemNotice( role ,"Blueprint usage count=="..paper_num)
	if paper_num==0 then
		SystemNotice( role ,"Blueprint is not longer usable. Discard it")
		return 0
	end
	local a1 = CheckBagItem( role, 855 )			---¾«ÁéÓ²±Ò
	local a1_num=GetItemAttr(Item[2], ITEMATTR_MAXURE )--¾«ÁéÓ²±ÒÐèÇó
	if a1< a1_num then
...
function Read_manufacture ( Table )
	...
	local role = Table [1]										--½ÇÉ«
	local ItemBagCount = Table [2]								--µÀ¾ß¶ÔÏóÊýÁ¿
	local ItemBag = {}										--µÀ¾ß±³°üÎ»ÖÃ
--	local ItemCount = {}										--µÀ¾ßÊýÁ¿
	local i = 0
...
function begin_manufacture_item (...)
	...
	for j = 1 , ItemBagCount , 1 do
		Item[j] = GetChaItem ( role , 2 , ItemBag [j] )			--È¡µÀ¾ßÖ¸Õë
		ItemID[j] = GetItemID ( Item[j] )						--È¡µÀ¾ß±àºÅ
		ItemType[j] = GetItemType ( Item[j] )					--È¡µÀ¾ßÀàÐÍ
	end
	local Gj_lv= 0-------------------¹¤¾ßµÈ¼¶
	if ItemID[3]==1068 then---------¹¤¾ß´æÔÚ
		Gj_lv=GetItemAttr ( Item[3] , ITEMATTR_VAL_STR )
	end
	local life_lv=GetSkillLv( role , SK_ZHIZAO )	-----È¡½ÇÉ«ÖÆÔì¼¼ÄÜµÈ¼¶

	local paper_lv = GetItemAttr(Item[2], ITEMATTR_URE )--È¡Í¼Ö½µÈ¼¶	

	local paper_energy = GetItemAttr(Item[2], ITEMATTR_MAXENERGY )-100--Í¼Ö½Éú³ÉÎïÆ·ÖÊÁ¿
...
function begin_manufacture3_item (...)
	...
	--------------¹¤¾ßµÈ¼¶Ã¿ÌáÉýÒ»¼¶+1%³É¹¦ÂÊ
	local Gj_lv=0
	if  ItemID[2]==1070 then---------¹¤¾ß´æÔÚ
		Gj_lv=GetItemAttr ( Item[2] , ITEMATTR_VAL_STR )
	end
	--------------½ÇÉ«µÈ¼¶Ã¿ÌáÉýÒ»¼¶+5%³É¹¦ÂÊ
	local life_lv = 0
	life_lv=GetSkillLv( role , SK_FENJIE )	-----È¡½ÇÉ«·Ö½â¼¼ÄÜµÈ¼¶
	--------------»ù´¡³É¹¦ÂÊ10%
...
function end_manufacture_item (...)
	...
	local i2 = 0
	local i3 = 0
	i1 =TakeItem( role, 0, paper_id1, Part2_paper)-- RemoveChaItem ( role , paper_id1 , Part2_paper , 2 , ItemBag [4] , 2 , 1 , 1)		--ÒÆ³ý
	i2 =TakeItem( role, 0, paper_id2, Part4_paper)-- RemoveChaItem ( role , paper_id2 , Part4_paper , 2 , ItemBag [5] , 2 , 1 , 1)		--ÒÆ³ý
	i3 =TakeItem( role, 0, paper_id3, Part6_paper)-- RemoveChaItem ( role , paper_id3 , Part6_paper , 2 , ItemBag [6] , 2 , 1 , 1)		--ÒÆ³ý
	...
	--------È¡³öÍ¼Ö½¸ø³öÎïÆ·µÄID
	local new_num = GetItemAttr(Item[2], ITEMATTR_VAL_AGI )--Í¼Ö½Éú³ÉÎïÆ·ID
	if ItemID[2]==2300 then ---------ÖÆÔìÍ¼Ö½
	...
	if star_check~=0 and star_good >star_radom and num_x~=0 then
		...
		if ItemID[2]==2301 and CheckItem_CanJinglian(Itemfinal)==1 then ---------ÖýÔìÉèÖÃµÀ¾ßÄÜÁ¿
			local Itemfinal_energy=GetItemAttr ( Itemfinal ,ITEMATTR_ENERGY) --------È¡×°±¸ÄÜÁ¿
			local itemfinal_maxenergy =GetItemAttrRange(new_num , ITEMATTR_MAXENERGY , 1 )-------±íÀïµÄ×î´óÖµ ---È¡Ö÷×°±¸µÀ¾ß×î´óÄÜÁ¿
			local itemfinal_minenergy = GetItemAttrRange(new_num ,ITEMATTR_MAXENERGY , 0 )--------±íÀïµÄ×îÐ¡Öµ ---È¡Ö÷×°±¸µÀ¾ßÄÜÁ¿
			...
			if itemfinal_maxenergy~=itemfinal_minenergy then ---------·ÇBOSS×°ÖØÉèÄÜÁ¿
		...
		if item_final_ID==1067 or item_final_ID==1068 or item_final_ID==1069 or item_final_ID==1070 then
			SetItemAttr(Itemfinal, ITEMATTR_VAL_STR ,1)--ÓÃÍ¼Ö½µÈ¼¶ÉèÖÃ¹¤¾ßµÈ¼¶
			SetItemAttr(Itemfinal, ITEMATTR_MAXENERGY ,10000)--ÉèÖÃ¹¤¾ß×î´óÄÜÁ¿
			SetItemAttr(Itemfinal, ITEMATTR_ENERGY ,1)--ÉèÖÃ¹¤¾ßµ±Ç°ÄÜÁ¿
			--local a=GetItemAttr(Itemfinal, ITEMATTR_VAL_STR )--ÓÃÍ¼Ö½µÈ¼¶ÉèÖÃ¹¤¾ßµÈ¼¶
			--local b=GetItemAttr(Itemfinal, ITEMATTR_MAXENERGY)--ÉèÖÃ¹¤¾ß×î´óÄÜÁ¿
			--local c=GetItemAttr(Itemfinal, ITEMATTR_ENERGY)--ÉèÖÃ¹¤¾ßµ±Ç°ÄÜÁ¿
			--SystemNotice( role , "Tool Level="..a)
			--SystemNotice( role , "Max Energy="..b)
			--SystemNotice( role , "Current Energy="..c)
		end
		if item_final_ID==2236 then
			SetItemAttr(Itemfinal, ITEMATTR_VAL_STR ,paper_lv)--ÓÃÍ¼Ö½µÈ¼¶ÉèÖÃÐÞ²¹¹¤¾ßµÈ¼¶
		end
	else
	...
	--if paper_num<=0 then
	--	local s1 = 0
	--	s1= RemoveChaItem ( role , ItemID[2] , 1 , 2 , ItemBag [2] , 2 , 1 , 1)		--ÒÆ³ý
	...
	if ItemID[3]==1067 or ItemID[3]==1068 or ItemID[3]==1069 or ItemID[3]==1070 then---------¹¤¾ß´æÔÚ
		...
		--if Gj_ure==0 then
		--	local k1 = 0
		--	k1= RemoveChaItem ( role , ItemID[3] , 1 , 2 , ItemBag [3] , 2 , 1 , 1)		--ÒÆ³ý
	 	--	SystemNotice( role , "Life of tool has reached its limit.")
		--	if k1 == 0 then
		--		LG( "FENJIE_BS" , "Delete item failed" )
		--	end
		--end
		local star_lv_num = GetItemAttr( Item[3] ,ITEMATTR_ENERGY )       --µÀ¾ß¾«Á¶ÐÅÏ¢ÓÐÒÔ¼ÇÂ¼¹¤¾ß¾­Ñé
		if star_check_chenggong==1 then-------ÖÆ×÷³É¹¦Ê±£¬¹¤¾ß³¤¾­Ñé
		...
		if star_lv_num>=star_gjlv_num*star_gjlv_num*100 then --------¹¤¾ßÉý¼¶Ìõ¼þ
			star_gjlv_num=star_gjlv_num+1
			SetItemAttr ( Item[3] , ITEMATTR_VAL_STR ,star_gjlv_num)----------ÖØÉè¹¤¾ßµÈ¼¶
	...
	SynChaKitbag(role,13)
	--check_item_final_data(Item[2])--------Í¼Ö½ÊôÐÔÖØËã
	--check_item_final_data(Item[3])--------¹¤¾ßÊôÐÔÖØËã
	return m2
end
...
function can_fenjie_item_main ( Table )
	...
	for i = 1 , ItemBagCount , 1 do							--ÅÐ¶ÏµÀ¾ß¸öÊýÊÇ·ñºÍ·¨
		...
		--	return 0
		--end
		--È¡³öµÀ¾ß(1-¾«Áé,2-¹¤¾ß,3-Ô­ÁÏ,4-·Ö½â·½Ïò)
		Item[i] = GetChaItem ( role , 2 , ItemBag [i] )			--È¡µÀ¾ßÖ¸Õë
		ItemID[i] = GetItemID ( Item[i] )						--È¡µÀ¾ßID
		ItemType[i] = GetItemType ( Item[i] )					--È¡µÀ¾ßÀàÐÍ
	...
	if ItemID[4] ~=2625 and ItemID[4] ~=2630 and ItemID[4] ~=2634 and ItemID[4] ~=2635 and ItemID[4] ~=2636 and ItemID[4] ~=2637 and ItemID[4] ~=2638  then	---´ß»¯¼Á
...
function end_fenjie_item (...)
	...
	local i1 = 0
	local i2 = 0
	i1= RemoveChaItem ( role , ItemID[3] , 1 , 2 , ItemBag [3] , 2 , 1 , 1)		--ÒÆ³ý
	i2= RemoveChaItem ( role , ItemID[4] , 1 , 2 , ItemBag [4] , 2 , 1 , 1)		--ÒÆ³ý
	if i1 == 0 or  i2 == 0 then
		LG( "Hecheng_BS" , "Delete item failed" )
	end
	local new_num=1346
	if ItemID[4] ==2625 then	---Ê¯²Ä´ß»¯¼Á
		local rad1=0
		if Item_Lv>=80 then
	...
	elseif ItemID[4] ==2630	 then ---Ê³²Ä´ß»¯¼Á
		local rad1=0
		if Item_Lv>=80 then
	...
	elseif ItemID[4] ==2634	 then ---ÌØÊâ´ß»¯¼Á
		local rad1=0
		if Item_Lv>=80 then
	...
	elseif ItemID[4] ==2635	 then ---¹ÇÍ·´ß»¯¼Á
		local rad1=0
		if Item_Lv>=80 then
	...
	elseif ItemID[4] ==2636	 then ---Ö²Îï´ß»¯¼Á
		local rad1=0
		if Item_Lv>=70 then
	...
	elseif ItemID[4] ==2637 then ---Ã«Æ¤´ß»¯¼Á
		local rad1=0
		if Item_Lv>=70 then
	...
	elseif ItemID[4] ==2638 then ---ÒºÌå´ß»¯¼Á
		local rad1=0
		if Item_Lv>=50 then
	...
	if ItemID[2]==1070 then---------¹¤¾ß´æÔÚ
		...
		--if Gj_ure==0 then
		--	local k1 = 0
		--	k1= RemoveChaItem ( role , ItemID[2] , 1 , 2 , ItemBag [2] , 2 , 1 , 1)		--ÒÆ³ý
	 	--	SystemNotice( role , "Life of tool has reached its limit.")
		--	if k1 == 0 then
		--		LG( "FENJIE_BS" , "Delete item failed" )
		--	end
		--end
		local star_lv_num = GetItemAttr( Item[2] ,ITEMATTR_ENERGY )       --µÀ¾ß¾«Á¶ÐÅÏ¢ÓÐÒÔ¼ÇÂ¼¹¤¾ß¾­Ñé
		star_lv_num=star_lv_num+1-------ÖÆ×÷³É¹¦Ê±£¬¹¤¾ß³¤¾­Ñé
		if star_lv_num>=10000 then
			star_lv_num=10000
		end
	 	SystemNotice( role , "Your tool currently has "..star_lv_num.." point(s) of experience")
		...
		if star_lv_num>=star_gjlv_num*star_gjlv_num*100 then --------¹¤¾ßÉý¼¶Ìõ¼þ
			star_gjlv_num=star_gjlv_num+1
			SetItemAttr ( Item[2] , ITEMATTR_VAL_STR ,star_gjlv_num)----------ÖØÉè¹¤¾ßµÈ¼¶
	 		SystemNotice( role , "Congratulations, your tool has increase in level!")
			star_lv_num=0
		end
...
--ÐÞÀíÆÆ¹ø
--ÅÐ¶ÏÊÇ·ñÄÜ¹»ÐÞÀíÆÆ¹ø£¬ÐÞÀíÆÆ¹øº¯ÊýÈë¿Ú
...
function can_shtool_item_main ( Table )
	...
	--------È¡³öµÀ¾ßÖ¸Õë
	local Item_mainitem = GetChaItem ( role , 2 , ItemBag [0] )	--ÆÆ¹øµÀ¾ßÖ¸Õë
	local Item_otheritem = GetChaItem ( role , 2 , ItemBag [1] )	--îçÌúµÀ¾ßÖ¸Õë
	--------È¡µÀ¾ßÀàÐÍ	
	local  ItemType_mainitem = GetItemType ( Item_mainitem )
	local  ItemType_otheritem = GetItemType ( Item_otheritem )
	...
	-------È¡ÆÆ¹øÄÍ¾Ã
	local item_shtool_ure = GetItemAttr(Item_mainitem,ITEMATTR_URE) ---µ±Ç°ÄÍ¾Ã
	local item_shtool_maxure = GetItemAttr(Item_mainitem,ITEMATTR_MAXURE) ---×î´óÄÍ¾Ã
	-------ÊÇ·ñÊôÓÚÆÆ¹ø
...
----Ïà¹Øº¯Êý--------------------------------------------------------------------------------------------------------		elseif funclist[id].func == PlayEffect then
...
function shtool_item ( Table )
	...
	local R1 = 0
	R1 = RemoveChaItem ( role , Item_otheritem , 1 , 2 , ItemBag [1] , 2 , 1 , 0 )		--ÒÆ³ýîçÌú
	if R1 == 0 then
		SystemNotice( role , "moved item failed ")
		return
	end
...
-----------------------------------------------×ÖÄ¸¿¨¶Ò»»
 function GetChaName_6 ( role,npc )
	...
	local el_count10 = CheckBagItem ( role ,3872 )--¼ì²é±³°üÖÐ¿¨Æ¬ÊýÁ¿
...
function NewbieBuff1( role )
	...
	local money = HasMoney(role , 1000)   --Ïðîâåðêà íà íàëè÷èå íóæíîãî êîëè÷åñòâà çîëîòà (ïî óìîë÷àíèþ 1000)
	
	if money == 0 then   --Åñëè ñóììû íåäîñòàòî÷íî, òî
		SystemNotice( role ,"Ó Âàñ íåäîñòàòî÷íî çîëîòà! ")   --Âûâåñòè ñèñòåìíîå ñîîáùåíèå î íåäîñòàòêå çîëîòà
	end
	
	local StateType = GetChaStateLv ( role , STATE_QINGZ )   --Ïðîâåðêà íàëîæåí ëè óæå ýòîò áàôô
	if StateType == 0 then   --Åñëè íå íàëîæåí, òî
		AddState ( role , role , STATE_QINGZ , 15 , 300 )   --Íàëîæèòü ñîñòîÿíèå STATE_QINGZ íà ïåðñîíàæà, ñðîêîì íà 300 ñåêóíä (5 ìèíóò), ñ óðîâíåì ñîñòîÿíèÿ 15 (íå ìåíÿòü!)
		TakeMoney (role, nil, 1000)  --Îòîáðàòü ó ïåðñîíàæà 1000 çîëîòà
		SystemNotice( role ,"Ïîëó÷åíî Áëàãîñëîâëåíèå íîâè÷êà, Âàøà çàùèòà ïîâûøåíà íà 20 ïóíêòîâ íà 5 ìèíóò! ")   --Âûâåñòè ñèñòåìíîå ñîîáùåíèå îá óäà÷íîì íàëîæåíèè áàôôà
	else   --Â ïðîòèâíîì ñëó÷àå
		SystemNotice( role ,"Ó Âàñ óæå åñòü Áëàãîñëîâëåíèå íîâè÷êà! ")   --Âûâåñòè ñîîáùåíèå ÷òî áàôô íà èãðîêà óæå áûë íàëîæåí
	end
end
...
function NewbieBuff2( role )
	...
	if money == 0 then
		SystemNotice( role ,"Ó Âàñ íåäîñòàòî÷íî çîëîòà! ")
	end
	...
	if StateType == 0 then
		...
		SystemNotice( role ,"Ïîëó÷åíî Áëàãîñëîâëåíèå íîâè÷êà, Âàøà àòàêà ïîâûøåíà íà 10 ïóíêòîâ íà 5 ìèíóò! ")
	else
		SystemNotice( role ,"Ó Âàñ óæå åñòü Áëàãîñëîâëåíèå íîâè÷êà! ")
	end
end
...
function NewbieBuff3( role )
	...
	if StateType == 0 then
		...
		TakeMoney (role, nil, 1000)
		SystemNotice( role ,"Ïîëó÷åíî Áëàãîñëîâëåíèå íîâè÷êà, Âàø óðîâåíü æèçíè ïîâûøåí íà 50 ïóíêòîâ íà 5 ìèíóò! ")
	else
		SystemNotice( role ,"Ó Âàñ óæå åñòü Áëàãîñëîâëåíèå íîâè÷êà! ")
	end
end
...
function StandartBuff1( role )
	...
	if StateType == 0 then
		AddState( role , role , STATE_XLZH, 10 , 300 ) --Íàëîæèòü ñîñòîÿíèå STATE_XLZH (Ïðèçðà÷íûé îãîíü) 10ëâë ñðîêîì íà 300 ñåêóíä (5 ìèíóò). Çäåñü óðîâåíü ñîñòîÿíèÿ ÌÎÆÍÎ ìåíÿòü. Óðîâåíü ñîñòîÿíèÿ áóäåò ñîîòâåòñâîâàòü óðîâíþ íàêëàäûâàåìîãî çàêëèíàíèÿ.
		TakeMoney (role, nil, 10000)
		SystemNotice( role ,"Íàëîæåí Ïðèçðà÷íûé îãîíü 10ëâë íà 5 ìèíóò! ")
	else
		SystemNotice( role ,"Íåëüçÿ èñïîëüçîâàòü îäíîâðåìåííî äâà çàêëèíàíèÿ îäíîãî òèïà! ")
	end
end
...
function StandartBuff2( role )
	...
	if StateType == 0 then
		...
		TakeMoney (role, nil, 10000)
		SystemNotice( role ,"Íàëîæåíà Çàêàëêà 10ëâë íà 5 ìèíóò! ")
	else
		SystemNotice( role ,"Íåëüçÿ èñïîëüçîâàòü îäíîâðåìåííî äâà çàêëèíàíèÿ îäíîãî òèïà! ")
	end
end
...
function StandartBuff3( role )
	...
	if StateType == 0 then
		...
		TakeMoney (role, nil, 10000)
		SystemNotice( role ,"Íàëîæåí Àíãåëüñêèé ùèò 10ëâë íà 5 ìèíóò! ")
	else
		SystemNotice( role ,"Íåëüçÿ èñïîëüçîâàòü îäíîâðåìåííî äâà çàêëèíàíèÿ îäíîãî òèïà! ")
	end
end
...
function StandartBuff4( role )
	...
	if StateType == 0 then
		...
		TakeMoney (role, nil, 10000)
		SystemNotice( role ,"Íàëîæåíà Èíòåíñèâíàÿ ìàãèÿ 10ëâë íà 5 ìèíóò! ")
	else
		SystemNotice( role ,"Íåëüçÿ èñïîëüçîâàòü îäíîâðåìåííî äâà çàêëèíàíèÿ îäíîãî òèïà! ")
	end
end
