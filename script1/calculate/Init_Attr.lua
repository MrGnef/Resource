...
SetChaAttrMax( ATTR_BSTR		,	200			)	-- 基本力量             
SetChaAttrMax( ATTR_BDEX		,	200			)	-- 基本灵巧             
SetChaAttrMax( ATTR_BAGI		,	200			)	-- 基本敏捷             
SetChaAttrMax( ATTR_BCON	,	200			)	-- 基本体质             
SetChaAttrMax( ATTR_BSTA		,	200			)	-- 基本精力             
...
SetChaAttrMax( ATTR_BDEF		,	5000			)	-- 基本防御力          
SetChaAttrMax( ATTR_BHIT		,	99999			)	-- 基本命中率          
SetChaAttrMax( ATTR_BFLEE	,	99999			)	-- 基本闪避率          
SetChaAttrMax( ATTR_BMF		,	99999			)	-- 基本寻宝率          
SetChaAttrMax( ATTR_BCRT		,	99999			)	-- 基本爆击率          
SetChaAttrMax( ATTR_BHREC	,	99999			)	-- 基本hp恢复速度   
SetChaAttrMax( ATTR_BSREC	,	99999			)	-- 基本sp恢复速度    
SetChaAttrMax( ATTR_BASPD	,	99999			)	-- 基本攻击间隔       
SetChaAttrMax( ATTR_BADIS	,	99999			)	-- 基本攻击距离       
SetChaAttrMax( ATTR_BMSPD	,	99999			)	-- 基本移动速度       
