...
--驯兽师职业属性成长比率———————————————————————————————————————————————————————————————————————————————————————————————————— 
		...
		Mxhp_con_rad1[JOB_TYPE_XUNSHOUSHI], Mxhp_con_rad2[JOB_TYPE_XUNSHOUSHI], Mxhp_lv_rad[JOB_TYPE_XUNSHOUSHI] = 100, 100, 100 						--最大hp的属性影响系数：体质系数、等级系数、基本数
		Mxsp_sta_rad1[JOB_TYPE_XUNSHOUSHI], Mxsp_sta_rad2[JOB_TYPE_XUNSHOUSHI], Mxsp_lv_rad[JOB_TYPE_XUNSHOUSHI] = 100, 100, 100						--最大sp的属性影响系数：精力系数、体质系数、等级系数
		Mnatk_str_rad1[JOB_TYPE_XUNSHOUSHI], Mnatk_str_rad2[JOB_TYPE_XUNSHOUSHI], Mnatk_dex_rad1[JOB_TYPE_XUNSHOUSHI], Mnatk_dex_rad2[JOB_TYPE_XUNSHOUSHI] = 100, 100, 100, 100					--最小攻击力的属性影响系数：力量系数
		Mxatk_str_rad1[JOB_TYPE_XUNSHOUSHI], Mxatk_str_rad2[JOB_TYPE_XUNSHOUSHI], Mxatk_dex_rad1[JOB_TYPE_XUNSHOUSHI], Mxatk_dex_rad2[JOB_TYPE_XUNSHOUSHI] = 100, 100, 100, 100 					--最大攻击的属性影响系数：力量系数
		Def_con_rad1[JOB_TYPE_XUNSHOUSHI], Def_con_rad2[JOB_TYPE_XUNSHOUSHI] = 100, 100 									--防御的属性影响系数：专注系数
		Hit_dex_rad1[JOB_TYPE_XUNSHOUSHI], Hit_dex_rad2[JOB_TYPE_XUNSHOUSHI] = 10, 10 									--命中的属性影响系数：专注系数、等级系数、最小命中率
		Flee_agi_rad1[JOB_TYPE_XUNSHOUSHI], Flee_agi_rad2[JOB_TYPE_XUNSHOUSHI] = 10, 10									--闪避的属性影响系数：敏捷系数、等级系数、最小闪避率
		Mf_luk_rad[JOB_TYPE_XUNSHOUSHI] = 10 															--暴料率的属性影响系数：幸运系数
		Crt_luk_rad[JOB_TYPE_XUNSHOUSHI] = 10														--暴击的属性影响系数：幸运系数、最小暴击率、最大暴击率
		Hrec_bsmxhp_rad[JOB_TYPE_XUNSHOUSHI], Hrec_con_rad[JOB_TYPE_XUNSHOUSHI] = 10/200, 10/100								--hp回复的属性影响系数：最大hp系数、等级系数、hp最小回复速度
		Srec_bsmxsp_rad[JOB_TYPE_XUNSHOUSHI], Srec_sta_rad[JOB_TYPE_XUNSHOUSHI] = 10/200, 10/120									--sp回复的属性影响系数：最大sp系数、等级系数、sp最小回复速度
		Aspd_agi_rad[JOB_TYPE_XUNSHOUSHI] = 10   												 		--攻击频率的属性影响系数：基础攻击、敏捷系数、最小攻击频率			
