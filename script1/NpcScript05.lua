...
function dukun_3()
	...
	Text( 8, "I Want to Be Crusader", JumpPage, 31 )
	...
	TriggerAction( 1, JumpPage, 10 )
	TriggerFailure( 1, JumpPage, 11 )
	Text( 31, "Ok, Swordman to be Crusader", MultiTrigger, GetMultiTrigger(), 2)
	Text( 31, "No. Maybe later", JumpPage, 2 )
...
function dukun_2()
	...
	Text( 8, "I Wanna Be Hunter", JumpPage, 9 )
	Text( 8, "I Wanna Be Explorer", JumpPage, 12 )
	Text( 8, "I Wanna Be Herbalis", JumpPage, 13 )
	Text( 8, "I Wanna Be Swordman", JumpPage, 30 )
	...
	TriggerAction( 1, JumpPage, 10 )
	TriggerFailure( 1, JumpPage, 11 )
	Text( 30, "Ok, I will become a Swordman", MultiTrigger, GetMultiTrigger(), 2)
	Text( 30, "No. Maybe later", JumpPage, 8 )
